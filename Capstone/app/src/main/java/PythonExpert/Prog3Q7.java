...
public class Prog3Q7 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q7);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("inheritance")){
                    Toast.makeText(Prog3Q7.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==109) {
                        startActivity(new Intent(Prog3Q7.this,Prog3Prob7.class));
                        finish();
                        PtsNumber = 110;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q7.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q7.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q7.this, Pactivity3.class));
        finish();
    }
}