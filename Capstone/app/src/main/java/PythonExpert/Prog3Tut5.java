...
public class Prog3Tut5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut5);
        ...
        firsts = ("Class methods in Python are methods that are bound to the class rather than the instance of the class.");
        second = ("They are defined using the @classmethod decorator and take the class itself (cls) as the first parameter instead of the instance (self).");
        third = ("Class methods can access and modify class variables, providing behavior that affects all instances of the class.");
        handler = new Handler();
    ...
    void First(final Prog3Tut5.Typing type){
    ...
    void Second(final Prog3Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut5.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut5.this, Pactivity3.class));
        finish();
    }
}