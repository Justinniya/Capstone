...
import com.example.capstone.Example.E1example13;
...
public class Prog3Tut13 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut13);
        ...
        firsts = ("Abstract Base Classes (ABCs) in Python are classes that cannot be instantiated themselves but define a set of methods that must be implemented by subclasses.");
        second = ("They are used to define a common interface for a group of subclasses, ensuring that they all implement the required methods.");
        third = ("ABCs are defined using the abc module and the @abstractmethod decorator.\n");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 126) {
                    ...
                    startActivity(new Intent(Prog3Tut13.this, E1example13.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    void First(final Prog3Tut13.Typing type){
    ...
    void Second(final Prog3Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut13.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut13.this, Pactivity3.class));
        finish();
    }
}