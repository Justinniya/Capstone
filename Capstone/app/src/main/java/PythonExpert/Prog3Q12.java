...
public class Prog3Q12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q12);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("polymorphism")){
                    Toast.makeText(Prog3Q12.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==124) {
                        startActivity(new Intent(Prog3Q12.this,Prog3Prob12.class));
                        finish();
                        PtsNumber = 125;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q12.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q12.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q12.this,Pactivity3.class));
        finish();
    }
}