...
public class Prog3Q2 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("instance and class variables")){
                    Toast.makeText(Prog3Q2.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==94) {
                        startActivity(new Intent(Prog3Q2.this,Prog3Prob2.class));
                        finish();
                        PtsNumber = 95;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q2.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q2.this, Prog3Tut2.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q2.this, Pactivity3.class));
        finish();
    }
}