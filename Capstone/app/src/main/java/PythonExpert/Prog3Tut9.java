...
import com.example.capstone.Example.E1example9;
...
public class Prog3Tut9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut9);
        ...
        firsts = ("Multiple inheritance in Python allows a class to inherit attributes and methods from more than one parent class.");
        second = ("This means that a class can have multiple superclass relationships.");
        third = ("When a method or attribute is called on an instance of the class,");
        fourth = ("Python searches for the method or attribute in the current class first,");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 114) {
                    ...
                    startActivity(new Intent(Prog3Tut9.this, E1example9.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    private void Show(){
        ...
        build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Tut9.this, Python1Q1.class));
                PtsNumber = 115;
    ...
    void First(final Prog3Tut9.Typing type){
    ...
    void Second(final Prog3Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut9.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut9.this,Pactivity3.class));
        finish();
    }
}