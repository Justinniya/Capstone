...
public class Prog3Q3 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q3);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("print")){
                    Toast.makeText(Prog3Q3.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==1) {
                        startActivity(new Intent(Prog3Q3.this,Prog1Prob1.class));
                        finish();
                        PtsNumber = 2;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q3.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q3.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q3.this, Pactivity3.class));
        finish();
    }
}