...
public class Prog3Tut15 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut15);
        ...
        firsts = ("Property decorators in Python are a way to define getter, setter, and deleter methods for class attributes in a more concise and readable manner.");
        second = ("They allow you to define these methods using the");
        third = ("@property, @<attribute_name>.setter, and @<attribute_name>.deleter decorators respectively, without the need to explicitly call them when accessing or modifying attributes.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 132) {
                    ...
                    startActivity(new Intent(Prog3Tut15.this, E1example15.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    void First(final Prog3Tut15.Typing type){
    ...
    void Second(final Prog3Tut15.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut15.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut15.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut15.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut15.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut15.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut15.this, Pactivity3.class));
        finish();
    }
}