...
import com.example.capstone.Example.E1example11;
...
public class Prog3Tut11 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut11);
        ...
        firsts = ("In Python, a nested class is a class defined inside another class. It's often used when the inner class is closely related to the outer class and is not intended for use outside of it.");
        second = ("Nested classes can access the attributes and methods of the outer class.");
        third = ("They can be useful for organizing code and encapsulating functionality. ");
        fourth = ("However, they are not commonly used in Python compared to languages like Java.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 120) {
                    ...
                    startActivity(new Intent(Prog3Tut11.this, E1example11.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    void First(final Prog3Tut11.Typing type){
    ...
    void Second(final Prog3Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut11.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut11.this,Pactivity3.class));
        finish();
    }
}