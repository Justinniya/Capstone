...
public class Prog3Q10 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q10);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("encapsulation")){
                    Toast.makeText(Prog3Q10.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==118) {
                        startActivity(new Intent(Prog3Q10.this,Prog3Prob10.class));
                        finish();
                        PtsNumber = 119;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q10.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q10.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q10.this, Pactivity3.class));
        finish();
    }
}