...
public class Prog3Prob5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob5);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","class Dog:\n" +
                        ...
                        "print(dog1.info())  # Output: Buddy is 3 years old and has 4 legs.\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==2) {
                        ...
                        Intent intent = new Intent(Prog3Prob5.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob5.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob5.this, Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob5.this, Pactivity1.class));
            finish();
        }
