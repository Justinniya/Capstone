...
public class Prog3Prob10 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob10);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","class Employee:\n" +
                        "    def __init__(self, name, salary):\n" +
                        "        self.__name = name  # Private attribute\n" +
                        "        self.__salary = salary  # Private attribute\n" +
                        "\n" +
                        "    # Getter method to access private attribute name\n" +
                        "    def get_name(self):\n" +
                        "        return self.__name\n" +
                        "\n" +
                        "    # Setter method to modify private attribute name\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==2) {
                        ...
                        Intent intent = new Intent(Prog3Prob10.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob10.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob10.this, Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob10.this, Pactivity1.class));
            finish();
        }
