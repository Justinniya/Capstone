...
public class Prog3Tut14 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut14);
        ...
        firsts = ("Class attributes in Python are attributes that are associated with a class rather than an instance of the class.");
        second = ("They are defined within the class but outside of any class methods,");
        third = (" usually at the beginning of the class definition.");
        fourth = ("Class attributes are shared among all instances of the class and can be accessed using the class name.\n");
    ...
    void First(final Prog3Tut14.Typing type){
    ...
    void Second(final Prog3Tut14.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut14.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut14.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut14.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut14.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut14.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut14.this,Pactivity3.class));
        finish();
    }
}