...
public class Prog3Q5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q5);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("class methods")){
                    Toast.makeText(Prog3Q5.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==103) {
                        startActivity(new Intent(Prog3Q5.this,Prog3Prob5.class));
                        finish();
                        PtsNumber = 104;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q5.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q5.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q5.this, Pactivity3.class));
        finish();
    }
}