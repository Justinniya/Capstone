...
public class Prog3Prob11 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob11);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","class Outer:\n" +
                        "    def __init__(self, outer_attr):\n" +
                        "        self.outer_attr = outer_attr\n" +
                        "        self.inner = self.Inner()  # Creating an instance of Inner class\n" +
                        "\n" +
                        ...
                        "outer_obj = Outer(\"Outer attribute\")\n" +
                        ...
                        "# Accessing nested class attributes and methods\n" +
                        "print(outer_obj.inner.inner_attr)  # Output: Inner attribute\n" +
                        "outer_obj.inner.inner_method()  # Output: This is the inner method");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==2) {
                        ...
                        Intent intent = new Intent(Prog3Prob11.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob11.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob11.this, Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob11.this, Pactivity1.class));
            finish();
        }
