...
public class Prog3Q9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q9);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("multiple inheritance")){
                    Toast.makeText(Prog3Q9.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==115) {
                        startActivity(new Intent(Prog3Q9.this,Prog3Prob9.class));
                        finish();
                        PtsNumber = 116;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q9.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q9.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q9.this, Pactivity3.class));
        finish();
    }
}