...
public class Prog3Q8 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q8);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("overriding")){
                    Toast.makeText(Prog3Q8.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==112) {
                        startActivity(new Intent(Prog3Q8.this,Prog3Prob8.class));
                        finish();
                        PtsNumber = 113;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q8.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q8.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q8.this, Pactivity3.class));
        finish();
    }
}