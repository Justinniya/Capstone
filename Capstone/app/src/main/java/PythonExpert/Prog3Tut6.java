...
public class Prog3Tut6 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut6);
        ...
        firsts = ("Static methods in Python are methods that are not bound to an instance or class.");
        second = ("They are defined using the @staticmethod decorator and do not have access to the instance (self) or class (cls) variables.");
        third = ("They are used when a method does not require access to instance or");
        fourth = ("class variables and can be called without creating an instance of the class.\n");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 105) {
                    ...
                    startActivity(new Intent(Prog3Tut6.this, E1example6.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    private void Show(){
        ...
        build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Tut6.this, Python1Q1.class));
                PtsNumber = 106;
    ...
    void First(final Prog3Tut6.Typing type){
    ...
    void Second(final Prog3Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut6.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut6.this, HomeActivity.class));
        finish();
    }
}