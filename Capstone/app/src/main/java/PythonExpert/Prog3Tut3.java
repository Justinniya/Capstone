...
public class Prog3Tut3 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut3);
        ...
        firsts = ("A constructor in Python is a special method called __init__() that is automatically invoked when a new object of a class is created.");
        second = ("It initializes the object's attributes and any other setup required for the object to be usable.");
        third = ("The constructor is where you typically assign initial values to instance variables.\n");
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 46) {
                    ...
                    startActivity(new Intent(Prog3Tut3.this, E1example3.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    void First(final Prog3Tut3.Typing type){
    ...
    void Second(final Prog3Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut3.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut3.this, Pactivity3.class));
        finish();
    }
}