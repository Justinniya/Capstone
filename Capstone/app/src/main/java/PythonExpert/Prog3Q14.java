...
public class Prog3Q14 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q14);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("class attributes")){
                    Toast.makeText(Prog3Q14.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==130) {
                        startActivity(new Intent(Prog3Q14.this,Prog3Prob14.class));
                        finish();
                        PtsNumber = 131;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q14.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q14.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q14.this, Pactivity3.class));
        finish();
    }
}