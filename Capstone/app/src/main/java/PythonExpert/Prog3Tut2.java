...
public class Prog3Tut2 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut2);
        ...
        firsts = ("Instance variables are unique to each object instance of a class in Python.");
        second = ("They are defined within the class's methods using the self keyword and store data specific to each instance.");
        third = (" Class variables, however, are shared among all instances of a class and are defined within the class but outside of any class methods.");
    ...
    void First(final Prog3Tut2.Typing type){
    ...
    void Second(final Prog3Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut2.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut2.this, Pactivity3.class));
        finish();
    }
}