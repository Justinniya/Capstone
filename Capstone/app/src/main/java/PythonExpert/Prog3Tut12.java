...
public class Prog3Tut12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut12);
        ...
        firsts = ("Polymorphism in Python is the ability of different objects to respond to the same method or function call in different ways.");
        second = ("It allows objects of different classes to be treated as objects of a common superclass. ");
        third = ("This allows for more flexible and reusable code, as the same method can be used with different types of objects.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 123) {
                    ...
                    startActivity(new Intent(Prog3Tut12.this, E1example12.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    private void Show(){
        ...
        build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Tut12.this, Python1Q1.class));
                PtsNumber = 124;
    ...
    void First(final Prog3Tut12.Typing type){
    ...
    void Second(final Prog3Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut12.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut12.this, Pactivity3.class));
        finish();
    }
}