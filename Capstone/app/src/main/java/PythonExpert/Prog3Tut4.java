...
public class Prog3Tut4 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_tut4);
        ...
        firsts = ("Instance methods in Python are functions defined within a class that operate on instance variables of the class.");
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ptsNumbers== 99) {
                    ...
                    startActivity(new Intent(Prog3Tut4.this, E1example4.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    void First(final Prog3Tut4.Typing type){
    ...
    void Second(final Prog3Tut4.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog3Tut4.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog3Tut4.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fifth(final Prog3Tut4.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Sixth(final Prog3Tut4.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Seventh(final Prog3Tut4.Typing type){
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Tut4.this, Pactivity3.class));
        finish();
    }
}