...
public class Prog3Prob9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob9);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","class A:\n" +
                        "    def method_a(self):\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==2) {
                        ...
                        Intent intent = new Intent(Prog3Prob9.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob9.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob9.this, Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob9.this, Pactivity1.class));
            finish();
        }
