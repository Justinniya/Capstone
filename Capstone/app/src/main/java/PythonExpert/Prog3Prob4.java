...
public class Prog3Prob4 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob4);
...
// Insert the string at the cursor position
            ...
            public void onClick(View view) {
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==101) {
                        ...
                        Intent intent = new Intent(Prog3Prob4.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob4.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob4.this, Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob4.this, Pactivity1.class));
            finish();
        }
