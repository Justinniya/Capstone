...
public class Prog3Prob12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_prob12);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","class Animal:\n" +
                        "    def speak(self):\n" +
                        ...
                        "\n" +
                        "\n" +
                        "# Function that accepts any Animal object and calls its speak method\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==125) {
                        ...
                        Intent intent = new Intent(Prog3Prob12.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog3Prob12.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Prob12.this,Pactivity3.class));
        finish();
    }
    public void Points(){
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==android.R.id.home){
            startActivity(new Intent(Prog3Prob12.this, Pactivity1.class));
            finish();
        }
