...
public class Prog3Q11 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog3_q11);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("nested classes")){
                    Toast.makeText(Prog3Q11.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==121) {
                        startActivity(new Intent(Prog3Q11.this,Prog3Prob11.class));
                        finish();
                        PtsNumber = 122;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog3Q11.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog3Q11.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog3Q11.this, Pactivity3.class));
        finish();
    }
}