...
public class Prog2Code9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_code9);
...
// Insert the string at the cursor position
            ...
            public void onClick(View view) {
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==2) {
                        ...
                        Intent intent = new Intent(Prog2Code9.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog2Code9.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Code9.this, Pactivity2.class));
        finish();
    }
    public void Points(){
