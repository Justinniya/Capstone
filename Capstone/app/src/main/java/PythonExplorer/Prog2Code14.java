...
public class Prog2Code14 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_code14);
...
// Insert the string at the cursor position
            ...
            public void onClick(View view) {
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==86) {
                        ...
                        Intent intent = new Intent(Prog2Code14.this, Problem_Output2.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog2Code14.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Code14.this, Pactivity2.class));
        finish();
    }
    public void Points(){
