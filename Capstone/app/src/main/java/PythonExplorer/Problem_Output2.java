...
public class Problem_Output2 extends AppCompatActivity {
        ...
        if(Correcct.equals("Correct")){
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    AlertDialog.Builder build = new AlertDialog.Builder(Problem_Output2.this);
                    build.setTitle("Success");
                    build.setMessage("Congratulations");
                    build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(Problem_Output2.this, Pactivity2.class));
                            finish();
