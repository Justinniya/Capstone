...
public class Prog2Q12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q12);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("parameter and arguments")){
                    Toast.makeText(Prog2Q12.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==79) {
                        startActivity(new Intent(Prog2Q12.this,Prog2Code12.class));
                        finish();
                        PtsNumber = 80;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q12.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q12.this, Prog2Tut12.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q12.this, Pactivity2.class));
        finish();
    }
}