...
public class Prog2Q11 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q11);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("built-in function")){
                    Toast.makeText(Prog2Q11.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==76) {
                        startActivity(new Intent(Prog2Q11.this,Prog2Code11.class));
                        finish();
                        PtsNumber = 77;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q11.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q11.this, Prog2Tut11.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q11.this, Pactivity2.class));
        finish();
    }
}