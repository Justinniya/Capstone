...
public class Prog2Code13 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_code13);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Prob1R.equals(EOutput)) {
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog2Code13.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Code13.this, Pactivity2.class));
        finish();
    }
    public void Points(){
