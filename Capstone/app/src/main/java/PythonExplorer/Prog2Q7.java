...
public class Prog2Q7 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q7);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("iterating")){
                    Toast.makeText(Prog2Q7.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==64) {
                        startActivity(new Intent(Prog2Q7.this,Prog2Code7.class));
                        finish();
                        PtsNumber = 65;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q7.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q7.this, Prog2Tut7.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q7.this, Pactivity2.class));
        finish();
    }
}