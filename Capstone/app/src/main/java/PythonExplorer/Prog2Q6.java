...
public class Prog2Q6 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q6);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("append")){
                    Toast.makeText(Prog2Q6.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==61) {
                        startActivity(new Intent(Prog2Q6.this,Prog2Code6.class));
                        finish();
                        PtsNumber = 62;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q6.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q6.this, Prog2Tut6.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q6.this, Pactivity2.class));
        finish();
    }
}