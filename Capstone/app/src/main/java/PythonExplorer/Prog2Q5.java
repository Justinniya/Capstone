...
public class Prog2Q5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q5);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("replace")){
                    Toast.makeText(Prog2Q5.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==58) {
                        startActivity(new Intent(Prog2Q5.this,Prog2Code5.class));
                        finish();
                        PtsNumber = 59;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q5.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q5.this, Prog2Tut5.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q5.this, Pactivity2.class));
        finish();
    }
}