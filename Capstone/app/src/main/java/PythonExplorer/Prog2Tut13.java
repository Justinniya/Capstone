...
import com.example.capstone.Example.E2example13;
...
public class Prog2Tut13 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut13);
        ...
        firsts = ("Nested if/else statements in Python allow for multiple levels of conditional logic.");
        second = ("Each if statement is checked sequentially, and if its condition is true, the corresponding block of code is executed.");
        third = ("Nested if statements can be useful for handling complex decision-making scenarios in your code.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut13.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==81) {
                        ...
                        startActivity(new Intent(Prog2Tut13.this, E2example13.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut13.Typing type){
    ...
    void Second(final Prog2Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut13.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut13.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}