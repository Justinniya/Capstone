...
public class Prog2Tut7 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut7);
        ...
        firsts = ("Iterating over a list in Python is done using a for loop.");
        second = ("Each iteration, the loop assigns the current element to a variable.");
        third = ("The loop body then executes, allowing you to process or manipulate the element.");
        fourth = ("This process continues until all elements in the list have been iterated.");
        handler = new Handler();
    ...
    void First(final Prog2Tut7.Typing type){
    ...
    void Second(final Prog2Tut7.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut7.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut7.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut7.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}