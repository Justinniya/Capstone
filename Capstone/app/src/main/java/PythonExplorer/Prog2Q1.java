...
public class Prog2Q1 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q1);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("print")){
                    Toast.makeText(Prog2Q1.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==46) {
                        startActivity(new Intent(Prog2Q1.this,Prog1Prob1.class));
                        finish();
                        PtsNumber = 47;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q1.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q1.this, Python1Lesson1.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q1.this, Pactivity2.class));
        finish();
    }
}