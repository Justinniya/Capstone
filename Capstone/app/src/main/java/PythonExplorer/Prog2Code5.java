...
public class Prog2Code5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_code5);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Prob1R.equals(EOutput)) {
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog2Code5.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Code5.this,Pactivity2.class));
        finish();
    }
    public void Points(){
