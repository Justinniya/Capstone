...
public class Prog2Q9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q9);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("handling exception")){
                    Toast.makeText(Prog2Q9.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==70) {
                        startActivity(new Intent(Prog2Q9.this,Prog2Code9.class));
                        finish();
                        PtsNumber = 71;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q9.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q9.this, Prog2Tut9.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q9.this, Pactivity2.class));
        finish();
    }
}