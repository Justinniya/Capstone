...
import com.example.capstone.Example.E2example5;
...
public class Prog2Tut5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut5);
        ...
        firsts = ("The split() method in Python is used to split a string into a list of substrings based on a delimiter.");
        second = ("It takes an optional argument maxsplit to specify the maximum number of splits to perform.");
        third = ("If no delimiter is specified, it splits on whitespace by default.");
        fourth = ("Example: sentence.split(\" \").");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut5.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==57) {
                        ...
                        startActivity(new Intent(Prog2Tut5.this, E2example5.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut5.Typing type){
    ...
    void Second(final Prog2Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut5.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut5.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}