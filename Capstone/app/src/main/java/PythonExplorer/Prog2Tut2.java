...
public class Prog2Tut2 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut2);
        ...
        firsts = ("A return value in a function is the result that the function gives back after it completes its task.");
        second = ("It can be any data type or object. The return keyword is used to send this value back to the caller.");
        third = ("Example: def add(a, b): return a + b");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut2.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==48) {
                        ...
                        startActivity(new Intent(Prog2Tut2.this, E2example2.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut2.Typing type){
    ...
    void Second(final Prog2Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut2.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
