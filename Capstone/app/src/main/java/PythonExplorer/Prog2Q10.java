...
public class Prog2Q10 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q10);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("date and time")){
                    Toast.makeText(Prog2Q10.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==73) {
                        startActivity(new Intent(Prog2Q10.this,Prog2Code10.class));
                        finish();
                        PtsNumber = 74;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q10.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q10.this, Prog2Tut10.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q10.this, Pactivity2.class));
        finish();
    }
}