...
public class Prog2Q13 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q13);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("nested if/else")){
                    Toast.makeText(Prog2Q13.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==82) {
                        startActivity(new Intent(Prog2Q13.this,Prog2Code13.class));
                        finish();
                        PtsNumber = 83;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q13.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q13.this, Prog2Tut13.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q13.this, Pactivity2.class));
        finish();
    }
}