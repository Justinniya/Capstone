...
import com.example.capstone.Example.E2example3;
...
public class Prog2Tut3 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut3);
        ...
        firsts = ("String methods in Python are functions that operate on strings.");
        second = ("They can be used to manipulate strings in various ways, such as converting case.");
        third = ("Example: my_string = \"Hello, World!\" print(my_string.lower())");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut3.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==51) {
                        ...
                        startActivity(new Intent(Prog2Tut3.this, E2example3.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut3.Typing type){
    ...
    void Second(final Prog2Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut3.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut3.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}