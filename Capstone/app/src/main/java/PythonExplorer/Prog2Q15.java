...
public class Prog2Q15 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q15);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("anonymous")){
                    Toast.makeText(Prog2Q15.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==88) {
                        startActivity(new Intent(Prog2Q15.this,Prog2Code15.class));
                        finish();
                        PtsNumber = 89;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q15.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q15.this, Prog2Tut15.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q15.this, Pactivity2.class));
        finish();
    }
}