...
public class Prog2Tut6 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut6);
        ...
        firsts = ("The append() method in Python adds an element to the end of a list.");
        second = ("Example: my_list.append(5) adds 5 to the end of my_list.");
        third = ("The remove() method removes the first occurrence of a specified element from a list.");
        fourth = ("Example: my_list.remove(5) removes the first occurrence of 5 from my_list.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut6.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==60) {
                        ...
                        startActivity(new Intent(Prog2Tut6.this, E2example6.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut6.Typing type){
    ...
    void Second(final Prog2Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut6.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut6.this,Pactivity2.class));
        finish();
        tts.stop();
    }
}