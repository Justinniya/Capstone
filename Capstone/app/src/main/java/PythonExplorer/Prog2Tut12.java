...
import com.example.capstone.Example.E2example12;
...
public class Prog2Tut12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut12);
        ...
        firsts = ("Arguments and parameters are key concepts in Python functions. ");
        second = ("Parameters are variables in a function definition that represent the data that the function expects to receive.");
        third = (" Arguments are the actual values that are passed to the function when it is called.");
        fourth = ("Parameters are specified in the function definition, while arguments are provided in the function call.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut12.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==78) {
                        ...
                        startActivity(new Intent(Prog2Tut12.this, E2example12.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut12.Typing type){
    ...
    void Second(final Prog2Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut12.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut12.this,Pactivity2.class));
        finish();
        tts.stop();
    }
}