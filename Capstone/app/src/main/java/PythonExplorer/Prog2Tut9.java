...
import com.example.capstone.Example.E2example9;
...
public class Prog2Tut9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut9);
        ...
        firsts = ("Exception handling in Python allows you to manage errors during runtime.");
        second = ("The try block contains code that might raise an exception. If an exception occurs, the except block handles it.");
        third = ("The else block is executed if no exceptions occur, and the finally block is always executed, whether an exception occurred or not.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut9.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==69) {
                        ...
                        startActivity(new Intent(Prog2Tut9.this, E2example9.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut9.Typing type){
    ...
    void Second(final Prog2Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut9.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut9.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}