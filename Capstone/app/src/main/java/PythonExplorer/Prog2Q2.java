...
public class Prog2Q2 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("print")){
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q2.this, "Wrong code please try again, " +
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q2.this, Pactivity2.class));
        finish();
    }
}