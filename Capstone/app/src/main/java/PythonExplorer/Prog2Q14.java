...
public class Prog2Q14 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q14);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("global variable")){
                    Toast.makeText(Prog2Q14.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==85) {
                        startActivity(new Intent(Prog2Q14.this,Prog2Code14.class));
                        finish();
                        PtsNumber = 86;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q14.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q14.this, Prog2Tut14.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q14.this, Pactivity2.class));
        finish();
    }
}