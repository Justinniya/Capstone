...
import com.example.capstone.Example.E2example11;
...
public class Prog2Tut11 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_tut11);
        ...
        firsts = ("Built-in functions in Python are pre-defined functions that are available for use without the need to import any module.");
        second = ("hey perform common operations like mathematical calculations (abs(), max()), type conversion (int(), str()), and iteration (range()).");
        third = ("These functions simplify programming tasks and are fundamental to Python's functionality.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Prog2Tut11.this,Python1Q1.class));
                finish();
                tts.stop();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if(numbers == 1){
                    ...
                    if(ptsNumbers==75) {
                        ...
                        startActivity(new Intent(Prog2Tut11.this, E2example11.class));
                        finish();
                    }
                }
            }
    ...
    void First(final Prog2Tut11.Typing type){
    ...
    void Second(final Prog2Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Third(final Prog2Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    void Fourth(final Prog2Tut11.Typing type) {
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Tut11.this, Pactivity2.class));
        finish();
        tts.stop();
    }
}