...
public class Prog2Q3 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog2_q3);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Code.equals("toUpper")){
                    Toast.makeText(Prog2Q3.this, "Correct",Toast.LENGTH_LONG).show();
                    if(ptsNumbers==52) {
                        startActivity(new Intent(Prog2Q3.this,Prog2Code3.class));
                        finish();
                        PtsNumber = 53;
                    ...
                    if(attempt > 0) {
                        Toast.makeText(
                                Prog2Q3.this, "Wrong code please try again, " +
    ...
    private void Show(){
        ...
        build.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Prog2Q3.this, Prog2Tut3.class));
                finish();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog2Q3.this, Pactivity2.class));
        finish();
    }
}