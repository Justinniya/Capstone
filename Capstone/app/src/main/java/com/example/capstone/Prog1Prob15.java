...
public class Prog1Prob15 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob15);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","str1 = 'Hello'\n" +
                        "str2 = 'World'\n" +
                        "\n" +
                        "result = str1 + str2\n" +
                        "\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==44) {
                        ...
                        Intent intent = new Intent(Prog1Prob15.this,Problem_Output.class);

                        String Coorect = "Correct";
                        String cor = compileInput(Coorect);
                        PtsNumber = 45;
                        int Level = 2;
                        Toast.makeText(Prog1Prob15.this,"Correct" + PtsNumber,Toast.LENGTH_LONG).show();
                        sql.UpdatePoints(PtsNumber, emaill);
                        sql.Updatelevel(Level,emaill);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob15.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob15.this, Pactivity1.class));
        finish();
    }
    public void Points(){
