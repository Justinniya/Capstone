...
public class Python1Lesson9 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson9);
        ...
        firsts = ("Arithmetic operators in Python perform mathematical operations. ");
        second = ("For example, 2 + 3 results in 5 (addition), 5 - 3 results in 2 (subtraction), and 2 * 3 results in 6 (multiplication). ");
        third = ("Understanding these operators is essential for performing mathematical calculations in Python.");
        fourth = ("");
        handler = new Handler();
