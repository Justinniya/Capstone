...
import com.example.capstone.Python1Q7;
...
import PythonExpert.Prog3Q7;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q7;

public class E1example7 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example7);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example7.this, Prog3Q7.class));
                        finish();
