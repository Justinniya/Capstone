...
public class Prog1Prob1 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob1);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","print('Hello World')");
                ...
                if(Prob1R.equals(EOutput)) {
                    ...
                    Intent intent = new Intent(Prog1Prob1.this,Problem_Output.class);
                ...
                else if(Prob1R.isEmpty()){
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob1.this);
                    build.setTitle("Error");
                    String msg = Prob1R;
                    build.setMessage("Please input your code");
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob1.this, Pactivity1.class));
        finish();
    }
    public void Points(){
