...
public class Prog1Prob4 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob4);
...
// Insert the string at the cursor position
            ...
            public void onClick(View view) {
                ...
                if (Prob1R.equals(EOutput)) {
                    if (ptsNumbers == 11) {
                        ...
                        Intent intent = new Intent(Prog1Prob4.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob4.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob4.this, Pactivity1.class));
        finish();
    }
