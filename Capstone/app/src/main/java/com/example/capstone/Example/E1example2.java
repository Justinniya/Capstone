...
import com.example.capstone.Python1Q2;
...
import PythonExpert.Prog3Q2;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q2;

public class E1example2 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example2);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example2.this, Prog3Q2.class));
                        finish();
