...
public class Python1Lesson4 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson4);
        ...
        third = ("For example, names = ['Alice', 'Bob', 'Charlie'] creates a list of names, and print(names[0]) prints 'Alice'.");
        fourth = ("");
        handler = new Handler();
    ...
    private void Show(){
        ...
        build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(Python1Lesson4.this, Python1Q1.class));
                newptsNumbers = 10;
