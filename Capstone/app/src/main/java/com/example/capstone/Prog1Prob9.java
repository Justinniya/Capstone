...
public class Prog1Prob9 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob9);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","addition = 5 + 5\n" +
                        "print(Addition)");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==26) {
                        ...
                        Intent intent = new Intent(Prog1Prob9.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob9.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob9.this, Pactivity1.class));
        finish();
    }
    public void Points(){
