...
import com.example.capstone.Python1Q6;
...
import PythonExpert.Prog3Q6;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q6;

public class E1example6 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example6);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example6.this, Prog3Q6.class));
                        finish();
