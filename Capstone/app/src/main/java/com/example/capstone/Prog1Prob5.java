...
public class Prog1Prob5 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob5);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main", "names = ['Alice' ,'Bob', 'Charlie']\n" +
                        "print(names)\n");
                ...
                if (Prob1R.equals(EOutput)) {
                    if (ptsNumbers == 14) {
                        ...
                        Intent intent = new Intent(Prog1Prob5.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob5.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob5.this, Pactivity1.class));
        finish();
    }
