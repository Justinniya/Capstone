...
public class Python1Lesson8 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson8);
        ...
        firsts = ("In Python, arrays are not built-in data types, but the array module from the standard library can be used to create them.");
        second = ("However, lists are more commonly used for storing sequences of elements. ");
        third = ("Arrays store elements of the same data type with a fixed size, unlike lists. ");
        fourth = ("Elements in an array are accessed using square bracket notation, similar to lists.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Python1Lesson8.this,Python1Q8.class));
                finish();
                tts.stop();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson8.this,Pactivity1.class));
        finish();
        tts.stop();
    }
}