...
import PythonExpert.Prog3Prob10;
import PythonExpert.Prog3Prob11;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q11;
import PythonExplorer.Prog2Q4;

public class E2example11 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example11);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example11.this, Prog2Q11.class));
                        finish();
