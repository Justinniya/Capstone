...
import com.example.capstone.Python1Q3;
...
import PythonExpert.Prog3Q3;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q3;

public class E1example3 extends AppCompatActivity {
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e1example3);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example3.this, Prog3Q3.class));
                        finish();
