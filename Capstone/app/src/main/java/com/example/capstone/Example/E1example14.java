...
import com.example.capstone.Python1Q14;
...
import PythonExpert.Prog3Q14;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q14;

public class E1example14 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example14);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example14.this, Prog3Q14.class));
                        finish();
