...
import PythonExpert.Prog3Prob7;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;
import PythonExplorer.Prog2Q7;

public class E2example7 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example7);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example7.this, Prog2Q7.class));
                        finish();
