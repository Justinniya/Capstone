...
import PythonExpert.Prog3Prob5;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;
import PythonExplorer.Prog2Q5;

public class E2example5 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example5);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example5.this, Prog2Q5.class));
                        finish();
