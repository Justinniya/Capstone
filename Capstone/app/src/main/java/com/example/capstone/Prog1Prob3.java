...
public class Prog1Prob3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob3);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","number = '2'\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==8) {
                        ...
                        Intent intent = new Intent(Prog1Prob3.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob3.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob3.this, Pactivity1.class));
        finish();
    }
    public void Points(){
