...
import com.example.capstone.Python1Q9;
...
import PythonExpert.Prog3Q9;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q9;

public class E1example9 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example9);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example9.this, Prog3Q9.class));
                        finish();
