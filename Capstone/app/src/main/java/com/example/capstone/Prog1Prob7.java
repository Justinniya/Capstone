...
public class Prog1Prob7 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob7);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","students = {'Alice : 20, 'Bob' : 21, 'Charlie' : 22}\n");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==20) {
                        ...
                        Intent intent = new Intent(Prog1Prob7.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob7.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob7.this, Pactivity1.class));
        finish();
    }
    public void Points(){
