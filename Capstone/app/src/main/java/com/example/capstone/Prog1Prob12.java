...
import java.util.regex.Pattern;
    ...
    public class Prog1Prob12 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob12);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","for i in range (1,10):\n" +
                        "\tprint(num)");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==35) {
                        ...
                        Intent intent = new Intent(Prog1Prob12.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob12.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob12.this, Pactivity1.class));
        finish();
    }
    public void Points(){
