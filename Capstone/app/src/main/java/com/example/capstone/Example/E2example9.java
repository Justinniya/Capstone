...
import PythonExpert.Prog3Prob9;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;
import PythonExplorer.Prog2Q9;

public class E2example9 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example9);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example9.this, Prog2Q9.class));
                        finish();
