...
import com.example.capstone.Python1Q12;
...
import PythonExpert.Prog3Q12;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q12;

public class E1example12 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example12);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example12.this, Prog3Q12.class));
                        finish();
