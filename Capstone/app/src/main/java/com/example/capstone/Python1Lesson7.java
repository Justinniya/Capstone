...
public class Python1Lesson7 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson7);
        ...
        firsts = ("Dictionaries in Python store key-value pairs where keys are unique and map to specific values. ");
        second = ("They are created using curly braces, with each pair separated by a comma and the key and value separated by a colon.");
        third = ("For example, student = {'name': 'Alice', 'age': 25, 'grade': 'A'} creates a dictionary of student information. ");
        fourth = ("It's important for beginners to practice creating and manipulating dictionaries to understand their use in Python.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Python1Lesson7.this,Python1Q7.class));
                finish();
                tts.stop();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson7.this,Pactivity1.class));
        finish();
        tts.stop();
    }
}