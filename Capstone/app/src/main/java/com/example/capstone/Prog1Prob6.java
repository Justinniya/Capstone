...
public class Prog1Prob6 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob6);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","numbers = (1,2,3,4,5)\n" +
                        "print(numbers)\n");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==17) {
                        ...
                        Intent intent = new Intent(Prog1Prob6.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob6.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob6.this, Pactivity1.class));
        finish();
    }
    public void Points(){
