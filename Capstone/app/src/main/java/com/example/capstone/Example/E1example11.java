...
import com.example.capstone.Python1Q11;
...
import PythonExpert.Prog3Q11;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q11;

public class E1example11 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example11);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example11.this, Prog3Q11.class));
                        finish();
