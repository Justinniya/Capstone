...
public class Prog1Prob13 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob13);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","x = 1\n" +
                        "while(X <5):\n" +
                        "\tprint(x)\n" +
                        "\tx += 1\n");
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==38) {
                        ...
                        Intent intent = new Intent(Prog1Prob13.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob13.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob13.this, Pactivity1.class));
        finish();
    }
    public void Points(){
