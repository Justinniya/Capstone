...
public class Python1Lesson13 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson13);
        ...
        firsts = ("While loops in Python repeatedly execute a block of code as long as a specified condition is true, useful for tasks where repetition is needed until a condition is met.");
        second = (" For example, while i < 5: will iterate and print numbers 0 to 4 on new lines, ");
        third = ("incrementing i at each iteration. Another example uses while True: to keep asking for input until a valid number is entered.");
        fourth = ("");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(OldPtsNumber==36) {
                    ...
                    startActivity(new Intent(Python1Lesson13.this, Python1Q13.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson13.this,HomeActivity.class));
        finish();
        tts.stop();
        tts.shutdown();
    }
