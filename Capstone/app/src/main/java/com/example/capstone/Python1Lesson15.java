...
public class Python1Lesson15 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson15);
        ...
        firsts = ("String manipulation in Python involves modifying or manipulating strings to achieve a desired result, such as concatenating strings, extracting substrings, and formatting strings.");
        second = ("For example, concatenating strings using + joins two strings together, extracting a substring using slicing extracts a part of a string, and string formatting with placeholders allows for dynamic strings.");;
        third = ("Python also provides built-in methods like upper(), lower(), strip(), replace(), and split() for string manipulation.");
        fourth = ("Understanding string manipulation is essential for working efficiently with text data in programming.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Python1Lesson15.this,Python1Q15.class));
                finish();
                tts.stop();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson15.this,Pactivity1.class));
        finish();
        tts.stop();
    }
}