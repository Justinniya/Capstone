...
public class Python1Lesson12 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson12);
        ...
        firsts = ("For loops in Python are used to iterate over sequences or iterable objects.");
        second = ("The range() function is often used to generate a sequence of numbers for looping. ");
        third = ("For example, for i in range(5): will iterate over the numbers 0 to 4, printing each number on a new line.");
        fourth = ("");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(OldPtsNumber==33) {
                    ...
                    startActivity(new Intent(Python1Lesson12.this, Python1Q12.class));
                    finish();
                    tts.stop();
                    tts.shutdown();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson12.this,Pactivity1.class));
        finish();
        tts.stop();
        tts.shutdown();
    }
