...
import PythonExpert.Prog3Prob1;
import PythonExpert.Prog3Prob2;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q2;
import PythonExplorer.Prog2Q4;

public class E2example2 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example2);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example2.this, Prog2Q2.class));
                        finish();
