...
import com.example.capstone.Python1Q15;
...
import PythonExpert.Prog3Q15;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q15;

public class E1example15 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example15);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example15.this, Prog3Q15.class));
                        finish();
