...
import PythonExpert.Prog3Prob8;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;
import PythonExplorer.Prog2Q8;

public class E2example8 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example8);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example8.this, Prog2Q8.class));
                        finish();
