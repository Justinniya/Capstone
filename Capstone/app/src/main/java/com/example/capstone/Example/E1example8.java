...
import com.example.capstone.Python1Q8;
...
import PythonExpert.Prog3Q8;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q8;

public class E1example8 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example8);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example8.this, Prog3Q8.class));
                        finish();
