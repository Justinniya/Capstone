...
public class Prog1Prob2 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob2);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main", "age = 21\n" +
                        "print(age)");
                ...
                if (Prob1R.equals(EOutput)) {
                    if (ptsNumbers==5) {
                        ...
                        Intent intent = new Intent(Prog1Prob2.this, Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob2.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob2.this, Pactivity1.class));
        finish();
    }
    public void Points(){
