...
import com.example.capstone.Python1Q4;
...
import PythonExpert.Prog3Q4;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;

public class E1example4 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example4);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example4.this, Prog3Q4.class));
                        finish();
