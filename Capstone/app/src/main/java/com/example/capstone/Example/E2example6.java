...
import PythonExpert.Prog3Prob6;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q4;
import PythonExplorer.Prog2Q6;

public class E2example6 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example6);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example6.this, Prog2Q6.class));
                        finish();
