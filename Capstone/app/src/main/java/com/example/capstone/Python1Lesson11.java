...
public class Python1Lesson11 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson11);
        ...
        firsts = ("Logical operators in Python combine conditional statements. ");
        second = ("The and operator returns True if both operands are True, or returns True if at least one operand is True, and not returns the opposite of the operand's value.");
        third = ("For example, x > 5 and y < 10 returns True if x is greater than 5 and y is less than 10. ");
        fourth = ("Logical operators are used in control flow statements and conditional expressions to create complex conditions.");
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Python1Lesson11.this,Python1Q11.class));
                finish();
                tts.stop();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson11.this,Pactivity1.class));
        finish();
        tts.stop();
    }
}