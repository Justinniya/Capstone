...
public class Python1Lesson5 extends AppCompatActivity {
    long OldPtsNumber;
    long newptsNumbers;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python1_lesson5);
        ...
        firsts = ("Lists in Python are collections used to store items, which can be of different data types and are ordered starting from index 0.");
        second = ("They are created with square brackets and can be accessed using square bracket notation.");
        third = ("For example,creates a list of names ['Alice', 'Bob', 'Charlie'] and print names.");
        fourth = ("It's important for beginners to practice creating and manipulating lists to understand their use in Python.");
        handler = new Handler();
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Python1Lesson5.this,Python1Q5.class));
                finish();
                tts.stop();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Python1Lesson5.this,Pactivity1.class));
        finish();
        tts.stop();
    }
}