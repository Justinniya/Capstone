...
public class Prog1Prob14 extends AppCompatActivity {
    int PtsNumber;
    long ptsNumbers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prog1_prob14);
...
// Insert the string at the cursor position
        ...
        Run1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PyObject call = Eout.callAttr("main","x = 6\n" +
                        "if(x>5):\n" +
                ...
                if(Prob1R.equals(EOutput)) {
                    if(ptsNumbers==41) {
                        ...
                        Intent intent = new Intent(Prog1Prob14.this,Problem_Output.class);
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(Prog1Prob14.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Prog1Prob14.this, Pactivity1.class));
        finish();
    }
    public void Points(){
