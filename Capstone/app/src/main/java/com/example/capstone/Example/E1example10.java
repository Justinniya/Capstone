...
import com.example.capstone.Python1Q10;
...
import PythonExpert.Prog3Q10;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q10;

public class E1example10 extends AppCompatActivity {
    TextToSpeech tts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e1example10);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E1example10.this, Prog3Q10.class));
                        finish();
