...
import PythonExpert.Prog3Prob15;
import PythonExplorer.Prog2Q1;
import PythonExplorer.Prog2Q15;
import PythonExplorer.Prog2Q4;

public class E2example15 extends AppCompatActivity {
    TextToSpeech tts;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_e2example15);
            ...
            public void onClick(View view) {
                ...
                build.setPositiveButton("Procced", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(E2example15.this, Prog2Q15.class));
                        finish();
